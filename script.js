...
const domestic =
(DOMESTIC[state] || {})[auction] || 0;

const ocean =
OCEAN_FREIGHT[auction] || 0;

const total =
domestic + ocean;

document.getElementById("domestic")
.textContent =
...
const API_URL =
"https://wandering-bonus-bcd2.abuzerovniko.workers.dev";
...
const commerceType =
document.getElementById("commerceType").value;
...
const priceInvoice =
parseFloat(
document.getElementById("priceInvoice").value
) || 0;

const priceTransport =
parseFloat(
document.getElementById("priceTransport").value
) || 0;
...
if(!issueDateRaw){
showError(
"Zəhmət olmasa istehsal tarixini daxil edin."
);
return;
}
...
const tbody =
document.getElementById("dutyRows");

tbody.innerHTML = "";

(data.autoDuty?.duties || [])
.forEach(duty=>{
...
document.getElementById("dutyTotal")
.innerHTML =
total
